...
import Character6 from "@/assets/image/characters/character_6.png";
        ...
        <div className="m-auto max-w-[400px]">
          <MotionContainer className="flex flex-col items-center justify-center px-2">
            <m.div variants={varBounce().in}>
              <div level={3} className="text-center text-3xl">
                Xin lỗi, Trang Không Tồn Tại!
              </div>
            </m.div>

            <m.div variants={varBounce().in}>
              <div type="secondary" className="text-center">
                Rất tiếc, chúng tôi không tìm thấy trang bạn đang tìm kiếm. Có
                thể bạn đã nhập sai URL? Hãy chắc chắn kiểm tra lại chính tả.
              </div>
            </m.div>
            ...
            <m.div variants={varBounce().in}>
              ...
              >
                ...
                <defs>
                  ...
                  >
                    <stop stopColor={"#2facfa"} />
                    <stop offset="1" stopColor={"#006dc7 "} />
                  </linearGradient>
                </defs>
              </svg>
            </m.div>
